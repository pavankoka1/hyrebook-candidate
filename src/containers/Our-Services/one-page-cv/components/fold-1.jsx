...
function Fold1() {
	return (
		<div className="w-1320 mx-auto my-0 overflow-visible">
			<div className="d-flex overflow-visible">
				<div className="w-50p mt-120">
					<p className="mont-40 mb-20">Why is it important ?</p>
				...
				<div className="w-50p">
					<img
						className="t-72 p-absolute r-0"
						src={require('assets/images/our-services/one-page-cv/resume.svg')}
						alt="resume"
						style={{ zIndex: -1 }}
					/>
					<img
